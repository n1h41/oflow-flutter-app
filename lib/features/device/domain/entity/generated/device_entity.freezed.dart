...
abstract class $DeviceEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String macAddress, DeviceType type});
}
...
class _$DeviceEntityImpl implements _DeviceEntity {
  ...
  @override
  String toString() {
    return 'DeviceEntity(id: $id, name: $name, macAddress: $macAddress, type: $type)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, macAddress, type);
...
abstract class _DeviceEntity implements DeviceEntity {
  const factory _DeviceEntity(
      ...
      required final DeviceType type}) = _$DeviceEntityImpl;
